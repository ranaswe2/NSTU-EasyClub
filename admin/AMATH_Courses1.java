...
public class AMATH_Courses1 extends javax.swing.JFrame {

 
    public AMATH_Courses1() {
        initComponents();
        setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Course of A-MATH");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(250, 140, 240, 30);
    ...
    public void theQuery1(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/course_amath","root","");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AMATH_Courses1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AMATH_Courses1().setVisible(true);
            }
        });
    }
