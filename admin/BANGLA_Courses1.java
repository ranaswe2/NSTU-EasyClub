...
public class BANGLA_Courses1 extends javax.swing.JFrame {

 
    public BANGLA_Courses1() {
        initComponents();
        setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Course of BANGLA");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(230, 140, 240, 30);
    ...
    public void theQuery1(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/course_bangla","root","");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BANGLA_Courses1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BANGLA_Courses1().setVisible(true);
            }
        });
    }
