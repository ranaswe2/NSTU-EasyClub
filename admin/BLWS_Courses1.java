...
public class BLWS_Courses1 extends javax.swing.JFrame {

 
    public BLWS_Courses1() {
        initComponents();
        setVisible(true); 
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Course of BLWS");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(250, 140, 190, 30);
    ...
    public void theQuery1(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/course_blws","root","");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BLWS_Courses1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BLWS_Courses1().setVisible(true);
            }
        });
    }
