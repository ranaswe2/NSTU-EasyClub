...
public class ECONO_Courses1 extends javax.swing.JFrame {

 
    public ECONO_Courses1() {
        initComponents();
        setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Course of ECONOMICS");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(220, 140, 270, 30);
    ...
    public void theQuery1(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/course_economics","root","");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ECONO_Courses1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ECONO_Courses1().setVisible(true);
            }
        });
    }
