...
public class FTNS_Result_Panel1 extends javax.swing.JFrame {

   
    public FTNS_Result_Panel1() {
        initComponents();
        setVisible(true);
        setResizable(false);
    }
   ...
   public void theQuery2(String query){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FTNS_Result_Panel1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
