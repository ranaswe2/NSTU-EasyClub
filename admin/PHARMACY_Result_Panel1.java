...
public class PHARMACY_Result_Panel1 extends javax.swing.JFrame {

   
    public PHARMACY_Result_Panel1() {
        initComponents();
        setVisible(true);
        setResizable(false);
    }
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
         ...
         if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-1 Term-1")){
        theQuery10("UPDATE `y-1_t-1` SET name='"+name.getText()+"',trmcredit='"+tcredit.getText()+"',tgpa='"+tgpa.getText()+"',cmpcredit='"+ccredit.getText()+"',cgpa='"+cgpa.getText()+"' WHERE roll='"+roll.getText()+"'");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-1 Term-2")){
        theQuery10("UPDATE `y-1_t-2` SET name='"+name.getText()+"',trmcredit='"+tcredit.getText()+"',tgpa='"+tgpa.getText()+"',cmpcredit='"+ccredit.getText()+"',cgpa='"+cgpa.getText()+"' WHERE roll='"+roll.getText()+"'");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-2 Term-1")){
        theQuery10("UPDATE `y-2_t-1` SET name='"+name.getText()+"',trmcredit='"+tcredit.getText()+"',tgpa='"+tgpa.getText()+"',cmpcredit='"+ccredit.getText()+"',cgpa='"+cgpa.getText()+"' WHERE roll='"+roll.getText()+"'");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-2 Term-2")){
        theQuery10("UPDATE `y-2_t-2` SET name='"+name.getText()+"',trmcredit='"+tcredit.getText()+"',tgpa='"+tgpa.getText()+"',cmpcredit='"+ccredit.getText()+"',cgpa='"+cgpa.getText()+"' WHERE roll='"+roll.getText()+"'");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-3 Term-1")){
        theQuery10("UPDATE `y-3_t-1` SET name='"+name.getText()+"',trmcredit='"+tcredit.getText()+"',tgpa='"+tgpa.getText()+"',cmpcredit='"+ccredit.getText()+"',cgpa='"+cgpa.getText()+"' WHERE roll='"+roll.getText()+"'");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-3 Term-2")){
        theQuery10("UPDATE `y-3_t-2` SET name='"+name.getText()+"',trmcredit='"+tcredit.getText()+"',tgpa='"+tgpa.getText()+"',cmpcredit='"+ccredit.getText()+"',cgpa='"+cgpa.getText()+"' WHERE roll='"+roll.getText()+"'");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-4 Term-1")){
        theQuery10("UPDATE `y-4_t-1` SET name='"+name.getText()+"',trmcredit='"+tcredit.getText()+"',tgpa='"+tgpa.getText()+"',cmpcredit='"+ccredit.getText()+"',cgpa='"+cgpa.getText()+"' WHERE roll='"+roll.getText()+"'");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-4 Term-2")){
        theQuery10("UPDATE `y-4_t-2` SET name='"+name.getText()+"',trmcredit='"+tcredit.getText()+"',tgpa='"+tgpa.getText()+"',cmpcredit='"+ccredit.getText()+"',cgpa='"+cgpa.getText()+"' WHERE roll='"+roll.getText()+"'");
        }
        //-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
        else if((ssn.getText()).equals("2017-18") && (term.getText()).equals("Year-1 Term-1")){
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-1 Term-1")){
        theQuery10("INSERT INTO `y-1_t-1`(`roll`, `name`, `trmcredit`, `tgpa`, `cmpcredit`, `cgpa`) VALUES  ('"+roll.getText()+"','"+name.getText()+"','"+tcredit.getText()+"','"+tgpa.getText()+"','"+ccredit.getText()+"','"+cgpa.getText()+"')");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-1 Term-2")){
        theQuery10("INSERT INTO `y-1_t-2`(`roll`, `name`, `trmcredit`, `tgpa`, `cmpcredit`, `cgpa`) VALUES  ('"+roll.getText()+"','"+name.getText()+"','"+tcredit.getText()+"','"+tgpa.getText()+"','"+ccredit.getText()+"','"+cgpa.getText()+"')");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-2 Term-1")){
        theQuery10("INSERT INTO `y-2_t-1`(`roll`, `name`, `trmcredit`, `tgpa`, `cmpcredit`, `cgpa`) VALUES  ('"+roll.getText()+"','"+name.getText()+"','"+tcredit.getText()+"','"+tgpa.getText()+"','"+ccredit.getText()+"','"+cgpa.getText()+"')");
        }
        
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-2 Term-2")){
        theQuery10("INSERT INTO `y-2_t-2`(`roll`, `name`, `trmcredit`, `tgpa`, `cmpcredit`, `cgpa`) VALUES  ('"+roll.getText()+"','"+name.getText()+"','"+tcredit.getText()+"','"+tgpa.getText()+"','"+ccredit.getText()+"','"+cgpa.getText()+"')");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-3 Term-1")){
        theQuery10("INSERT INTO `y-3_t-1`(`roll`, `name`, `trmcredit`, `tgpa`, `cmpcredit`, `cgpa`) VALUES  ('"+roll.getText()+"','"+name.getText()+"','"+tcredit.getText()+"','"+tgpa.getText()+"','"+ccredit.getText()+"','"+cgpa.getText()+"')");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-3 Term-2")){
        theQuery10("INSERT INTO `y-3_t-2`(`roll`, `name`, `trmcredit`, `tgpa`, `cmpcredit`, `cgpa`) VALUES  ('"+roll.getText()+"','"+name.getText()+"','"+tcredit.getText()+"','"+tgpa.getText()+"','"+ccredit.getText()+"','"+cgpa.getText()+"')");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-4 Term-1")){
        theQuery10("INSERT INTO `y-4_t-1`(`roll`, `name`, `trmcredit`, `tgpa`, `cmpcredit`, `cgpa`) VALUES  ('"+roll.getText()+"','"+name.getText()+"','"+tcredit.getText()+"','"+tgpa.getText()+"','"+ccredit.getText()+"','"+cgpa.getText()+"')");
        }
        
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-4 Term-2")){
        theQuery10("INSERT INTO `y-4_t-2`(`roll`, `name`, `trmcredit`, `tgpa`, `cmpcredit`, `cgpa`) VALUES  ('"+roll.getText()+"','"+name.getText()+"','"+tcredit.getText()+"','"+tgpa.getText()+"','"+ccredit.getText()+"','"+cgpa.getText()+"')");
        }
        //-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-1 Term-1")){
        theQuery10("DELETE FROM `y-1_t-1` WHERE roll='"+roll.getText()+"'");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-1 Term-2")){
        theQuery10("DELETE FROM `y-1_t-2` WHERE roll='"+roll.getText()+"'");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-2 Term-1")){
        theQuery10("DELETE FROM `y-2_t-1` WHERE roll='"+roll.getText()+"'");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-2 Term-2")){
        theQuery10("DELETE FROM `y-2_t-2` WHERE roll='"+roll.getText()+"'");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-3 Term-1")){
        theQuery10("DELETE FROM `y-3_t-1` WHERE roll='"+roll.getText()+"'");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-3 Term-2")){
        theQuery10("DELETE FROM `y-3_t-2` WHERE roll='"+roll.getText()+"'");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-4 Term-1")){
        theQuery10("DELETE FROM `y-4_t-1` WHERE roll='"+roll.getText()+"'");
        }
        else if((ssn.getText()).equals("2016-17") && (term.getText()).equals("Year-4 Term-2")){
        theQuery10("DELETE FROM `y-4_t-2` WHERE roll='"+roll.getText()+"'");
        }
         //--------------------------------------------------------------------------------------//
    ...
    public void theQuery10(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/result_ pharma_1617","root","");
    ...
    public void theQuery1(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/result_ pharma_1718","root","");
            st=con.createStatement();
            st.executeUpdate(query);
            JOptionPane.showMessageDialog(null, "Query Executed.");
   ...
   public void theQuery2(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/result_ pharma_1819","root","");
            st=con.createStatement();
            st.executeUpdate(query);
            JOptionPane.showMessageDialog(null, "Query Executed.");
    ...
    public void theQuery3(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/result_ pharma_1920","root","");
            st=con.createStatement();
            st.executeUpdate(query);
            JOptionPane.showMessageDialog(null, "Query Executed.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PHARMACY_Result_Panel1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
