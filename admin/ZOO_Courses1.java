...
public class ZOO_Courses1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Course of ZOOLOGY");
        jPanel1.add(jLabel4);
    ...
    public void theQuery1(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/course_zoology","root","");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ZOO_Courses1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
