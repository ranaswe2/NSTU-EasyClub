...
public class BANGLA_Result_Panel1 extends javax.swing.JFrame {

   
    public BANGLA_Result_Panel1() {
        initComponents();
        setVisible(true);
        setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(wlcm);
        wlcm.setBounds(180, 110, 280, 20);

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setText("Roll");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(140, 250, 140, 17);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setText("Name");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(140, 300, 120, 17);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel6.setText("Term Credit");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(140, 350, 130, 17);

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel7.setText("TGPA");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(140, 400, 110, 17);

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setText("Completed Credit");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(140, 450, 140, 17);

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel9.setText("CGPA");
        jPanel1.add(jLabel9);
        jLabel9.setBounds(140, 500, 110, 17);

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel10.setText("Term");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(140, 200, 140, 17);

        term.setText("Year-1 Term-1");
        jPanel1.add(term);
        term.setBounds(270, 200, 230, 30);

        roll.setText("ASH1925001M");
        jPanel1.add(roll);
        roll.setBounds(270, 250, 230, 30);
        ...
        jPanel1.add(tcredit);
        tcredit.setBounds(270, 350, 230, 30);

        tgpa.setText("4.00");
        jPanel1.add(tgpa);
        tgpa.setBounds(270, 400, 230, 30);

        ccredit.setText("21");
        jPanel1.add(ccredit);
        ccredit.setBounds(270, 450, 230, 30);

        cgpa.setText("4.00");
        jPanel1.add(cgpa);
        cgpa.setBounds(270, 500, 230, 30);
        ...
        jPanel1.add(submit);
        submit.setBounds(230, 560, 90, 23);
        ...
        jPanel1.add(update);
        update.setBounds(140, 560, 90, 23);
        ...
        jPanel1.add(delete);
        delete.setBounds(410, 560, 90, 23);

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setText("Session");
        jPanel1.add(jLabel11);
        jLabel11.setBounds(140, 160, 120, 20);

        ssn.setText("2018-19");
        jPanel1.add(ssn);
        ssn.setBounds(270, 150, 230, 30);
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        if((ssn.getText()).equals("2018-19") && (term.getText()).equals("Year-1 Term-1")){
    ...
    public void theQuery1(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/result_bangla_1718","root","");
   ...
   public void theQuery2(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/result_bangla_1819","root","");
            st=con.createStatement();
            st.executeUpdate(query);
            JOptionPane.showMessageDialog(null, "Query Executed.");
    ...
    public void theQuery3(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/result_bangla_1920","root","");
            st=con.createStatement();
            st.executeUpdate(query);
            JOptionPane.showMessageDialog(null, "Query Executed.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BANGLA_Result_Panel1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
