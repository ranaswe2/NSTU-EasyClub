...
public class ECONO_Result_Panel1 extends javax.swing.JFrame {

   
    public ECONO_Result_Panel1() {
        initComponents();
        setVisible(true);
        setResizable(false);
    }
    ...
    public void theQuery10(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/result_economics_1617","root","");
    ...
    public void theQuery1(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/result_economics_1718","root","");
            st=con.createStatement();
            st.executeUpdate(query);
            JOptionPane.showMessageDialog(null, "Query Executed.");
   ...
   public void theQuery2(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/result_economics_1819","root","");
            st=con.createStatement();
            st.executeUpdate(query);
            JOptionPane.showMessageDialog(null, "Query Executed.");
    ...
    public void theQuery3(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/result_economics_1920","root","");
            st=con.createStatement();
            st.executeUpdate(query);
            JOptionPane.showMessageDialog(null, "Query Executed.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ECONO_Result_Panel1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
