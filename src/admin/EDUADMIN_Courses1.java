...
public class EDUADMIN_Courses1 extends javax.swing.JFrame {

 
    public EDUADMIN_Courses1() {
        initComponents();
        setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Course of EDU.ADMIN");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(220, 140, 290, 30);
    ...
    public void theQuery1(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/course_eduad","root","");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EDUADMIN_Courses1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EDUADMIN_Courses1().setVisible(true);
            }
        });
    }
