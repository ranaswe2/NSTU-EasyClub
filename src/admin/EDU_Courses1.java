...
public class EDU_Courses1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Course of EDUCATION");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(220, 140, 260, 30);
    ...
    public void theQuery1(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/course_education","root","");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EDU_Courses1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EDU_Courses1().setVisible(true);
            }
        });
    }
