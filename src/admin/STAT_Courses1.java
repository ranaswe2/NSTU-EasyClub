...
public class STAT_Courses1 extends javax.swing.JFrame {

 
    public STAT_Courses1() {
        initComponents();
        setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Course of STATISTICS");
        jPanel1.add(jLabel4);
    ...
    public void theQuery1(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/course_stat","root","");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(STAT_Courses1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new STAT_Courses1().setVisible(true);
            }
        });
    }
