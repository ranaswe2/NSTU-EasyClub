...
public class SW_Courses1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Course of SW");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(270, 140, 190, 30);
    ...
    public void theQuery1(String query){
        ...
        try {
            con= DriverManager.getConnection("jdbc:mysql://localhost/course_sw","root","");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SW_Courses1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SW_Courses1().setVisible(true);
            }
        });
    }
